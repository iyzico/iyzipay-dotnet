...
namespace Iyzipay.Tests.Functional
{
    public class IyziLinkTest : BaseTest
    {
        ...
        public void Should_Create_IyziLink()
        {
            ...
            IyziLinkSaveResource response = IyziLink.Create(request, _options);
        ...
        public void Should_Update_IyziLink()
        {
            ...
            IyziLinkSaveResource response = IyziLink.Update(token, updateRequest, _options);
            PrintResponse(response);
        ...
        public void Should_Retrieve_IyziLinks_With_Pagination()
        {
            ...
            IyziLinkPagingResource response = IyziLink.RetrieveAll(pagingRequest, _options);
            PrintResponse(response);
            ...
            Assert.AreEqual("123456789", response.ConversationId);
            Assert.NotNull(response.SystemTime);
            Assert.AreEqual(1,response.Data.IyziLinkItems.Count);
        ...
        public void Should_Retrieve_IyziLink_With_Token()
        {
            ...
            IyziLinkResource response = IyziLink.Retrieve(token, requestV2, _options);
            PrintResponse(response);
